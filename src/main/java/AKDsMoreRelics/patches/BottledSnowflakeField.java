package AKDsMoreRelics.patches;
...
public class BottledSnowflakeField {
    public static SpireField<Boolean> inBottledSnowflakeField = new SpireField<>(() -> false);
    ...
    public static class MakeStatEquivalentCopy {
        public static AbstractCard Postfix(AbstractCard result, AbstractCard self) {
            ...
            inBottledSnowflakeField.set(result, inBottledSnowflakeField.get(self)); // Read:
